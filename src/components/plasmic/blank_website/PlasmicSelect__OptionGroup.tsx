...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: xM61Rgkbiq_s/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Y7m2NWmGcoHf/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__ncZew)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___6EBHi)}
              />
            </React.Fragment>
          ),
          value: args.children
